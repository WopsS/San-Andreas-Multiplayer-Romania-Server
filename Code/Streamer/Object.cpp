...
const uint32_t Object::Create(uint32_t ModelID, const Point3D<float>& Position, const Point3D<float>& Rotation, int32_t VirtualWorld, int32_t Interior, int32_t PlayerID, float StreamDistance, float DrawDistance)
{
